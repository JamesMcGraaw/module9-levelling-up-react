...
const submittedAge: number | null = document.querySelector('input').value
const textToEdit: HTMLDivElement = document.querySelector('.answers')
...
const handleSubmit = (e: SubmitEvent): void => {
    ...
    "On Mercury you are " + (submittedAge * mercury)
    "On Venus you are " +
    "On Mars you are " +
    "On Jupiter you are " +
    "On Saturn you are " +
